				...
				<table class="table table-bordered table-striped table-hover">
                	<thead>
                    	<tr class="info fg-white">
                            ...
                            <th class="text-center">Tanggal Tour</th>
                            <th class="text-center">Paket Tour</th>
                            <th class="text-center">Tempat Penginapan</th>
                            <th class="text-center">Transport</th>
                            <th class="text-center">Harga Paket</th>
                            <th class="text-center">Harga Penginapan</th>
                    ...
                    $_mysqli = new mysqli('localhost', 'avanturi_admin', '@cotton1234', 'avanturi_db');
                    $comot = $_mysqli->query(
                        "select *from tbl_pesan,tbl_user,tbl_daerah,tbl_paket,tbl_hotel where tbl_pesan.id_user=tbl_user.id_user and tbl_pesan.id_paket=tbl_paket.id_paket and tbl_pesan.id_hotel=tbl_hotel.id_hotel and tbl_pesan.id_daerah=tbl_daerah.id_daerah and tbl_user.id_user='$id_user'"
                    );
