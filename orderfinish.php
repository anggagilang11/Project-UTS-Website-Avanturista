...
if (isset($_SESSION['id_user'])) {
    ...
    ob_start();
    $comot = $_mysqli->query(
        "SELECT * FROM tbl_pesan, tbl_paket, tbl_hotel, tbl_user WHERE tbl_pesan.id_user=tbl_user.id_user AND
						tbl_pesan.id_paket=tbl_paket.id_paket AND tbl_pesan.id_hotel=tbl_hotel.id_hotel AND id_pesan=" .
            $_GET['id']
    );
            ...
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
                    ...
                    <div style="position: absolute; right: 3mm; bottom: 3mm; text-align: right; font-size: 4mm; ">
                        Jenis Paket : <b><?php echo $isi_tbl[
                            'nama_paket'
                        ]; ?></b><br>
                        Total Biaya : <b><?php echo $total_harga; ?> IDR</b><br>
                        Code Booking : <b><?php echo $num; ?></b><br>
                        Tanggal Tour : <b><?php echo $isi_tbl[
                            'tgl_tour'
                        ]; ?></b><br>
                    </div>
                    <img src="images/be.png" width="100" height="99" />
					<span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">Avanturista</span><br />
...
try {
    ...
    $html2pdf->Output(
        'ticket00' . $isi_tbl['id_pesan'] . '-' . date('Y/m/d') . '.pdf'
    );
