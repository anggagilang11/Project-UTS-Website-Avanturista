				...
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p>Avanturista merupakan perusahaan yang bergerak di bidang jasa yang menghubungkan antara pengguna dan penyedia jasa</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Sleman, Yogyakarta</li>
								<li><i class="icon-phone2"></i>+085747367287</li>
								<li><i class="icon-mail"></i><a href="#">avanturista@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.avanturista.xyz</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
