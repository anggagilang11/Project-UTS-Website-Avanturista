<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo"><a href="index.php"><img src="./images/icon.png" height="50" width="50;"> Avanturista</a></h1>
 ...
 if (isset($_SESSION['nama_user'])) { ?>	<li><a href="order.php">Order</a></li>
